...
//        assertTrue("someLibraryMethod should return 'true'", classUnderTest.someLibraryMethod());
    ...
    public void TestAddReviewRes(){
        ...
        assertEquals("return true if add review",  test.getReviews().size());
    }
    ...
    public void TestAddReview(){
        ...
        assertEquals("return true if add review", testAdd.getReviews().size());
    }
    @Test
    public void TestAddAndRemoveReview(){
        Theater testAdd = new Theater("test");
        testAdd.addMovie("test1");
        assertEquals(1, testAdd.getMovies().size());
        testAdd.removeMovie("test1");
        assertEquals(0,  testAdd.getMovies().size());
    }
